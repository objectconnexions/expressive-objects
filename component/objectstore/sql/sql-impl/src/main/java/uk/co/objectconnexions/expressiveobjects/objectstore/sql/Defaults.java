...
public class Defaults {
    ...
    private static ExpressiveObjectsConfiguration expressiveObjectsConfiguration;
     ...
     * @param expressiveObjectsConfiguration
     */
    public static void initialise(final String propertiesBase, final ExpressiveObjectsConfiguration expressiveObjectsConfiguration) {
        Defaults.propertiesBase = propertiesBase; // "expressive-objects.persistor.sql"
        setTimeZone(DateTimeZone.UTC);

        Defaults.expressiveObjectsConfiguration = expressiveObjectsConfiguration;

        setTablePrefix(getStringProperty(propertiesBase, expressiveObjectsConfiguration, "tableprefix", "expressive-objects_"));
        setPkIdLabel(getStringProperty(propertiesBase, expressiveObjectsConfiguration, "pk_id"));
        setIdColumn(getStringProperty(propertiesBase, expressiveObjectsConfiguration, "id"));
        setMaxInstances(getIntProperty(propertiesBase, expressiveObjectsConfiguration, "maxinstances", 100));
        final String useVersioningProperty = getStringProperty(propertiesBase, expressiveObjectsConfiguration, "versioning", "true");
        ...
        final ExpressiveObjectsConfiguration dataTypes = expressiveObjectsConfiguration.getProperties(BASE_DATATYPE);
        populateSqlDataTypes(dataTypes, BASE_DATATYPE);

    }

    /**
     * Returns a string value by looking up "expressive-objects.persistor.sql.default.XXXX"
     * 
     * @param propertiesBase
     ...
     * @return
     */
    protected static String getStringProperty(final String propertiesBase, final ExpressiveObjectsConfiguration configParameters,
        final String property) {
        return configParameters.getString(propertiesBase + ".default." + property, property);
    }

    /**
     * Returns a string value by looking up "expressive-objects.persistor.sql.default.XXXX", returning the specified default, if no
     * value was found.
     * 
     * @param propertiesBase
     * @param configParameters
    ...
    /**
     * Returns an integer value by looking up "expressive-objects.persistor.sql.default.XXXX", returning the specified default, if no
     * value was found.
     * 
     * @param propertiesBase
     * @param configParameters
     ...
     * @return
     */
    protected static int getIntProperty(final String propertiesBase, final ExpressiveObjectsConfiguration configParameters,
    ...
    // {{ Table prefix, defaults to "expressive-objects_"
     ...
     * @param baseName
     */
    private static void populateSqlDataTypes(final ExpressiveObjectsConfiguration dataTypes, final String baseName) {
        ...
        PASSWORD_ENC_LENGTH = getIntProperty(propertiesBase, expressiveObjectsConfiguration, "password.length", 120);
        PASSWORD_SEED = getStringProperty(propertiesBase, expressiveObjectsConfiguration, "password.seed");
    ...
    public static boolean useVersioning(final String shortIdentifier) {
        ...
        final String useVersioningProperty =
            getStringProperty(propertiesBase, expressiveObjectsConfiguration, "versioning." + shortIdentifier, "true");
    ...
    private static void defineDatabaseCommands() {
        START_TRANSACTION =
            getStringProperty(propertiesBase, expressiveObjectsConfiguration, "command.beginTransaction", "START TRANSACTION;");
        ABORT_TRANSACTION =
            getStringProperty(propertiesBase, expressiveObjectsConfiguration, "command.abortTransaction", "ROLLBACK;");
        COMMIT_TRANSACTION =
            getStringProperty(propertiesBase, expressiveObjectsConfiguration, "command.commitTransaction", "COMMIT;");
    }
