...
import uk.co.objectconnexions.expressiveobjects.objectstore.sql.mapping.FieldMappingFactory;
import uk.co.objectconnexions.expressiveobjects.objectstore.sql.mapping.ObjectReferenceMapping;
import uk.co.objectconnexions.expressiveobjects.objectstore.sql.mapping.ObjectReferenceMappingFactory;
...
public class FieldMappingLookup {
    ...
    public FieldMapping createMapping(final ObjectSpecification object, final ObjectAssociation field) {
        ...
        if (factory != null) {
            ...
            return factory.createFieldMapping(object, field);
            // } else {
            // throw new ExpressiveObjectsException("No mapper for " + spec +
            // " (no default mapper)");
        }
    }
    ...
    public void addFieldMappingFactory(final Class<?> valueType, final FieldMappingFactory mapper) {
        final ObjectSpecification spec = ExpressiveObjectsContext.getSpecificationLoader().loadSpecification(valueType);
