...
public interface Results {
    ...
    uk.co.objectconnexions.expressiveobjects.applib.value.Date getDate(String columnName);

    uk.co.objectconnexions.expressiveobjects.applib.value.Time getTime(String columnName);
