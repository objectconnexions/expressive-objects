...
public class SqlExecutionContext implements PersistenceCommandContext {
    ...
    public SqlExecutionContext(final DatabaseConnector connection, final ExpressiveObjectsTransactionManager transactionManager, final MessageBroker messageBroker, final UpdateNotifier updateNotifier) {
