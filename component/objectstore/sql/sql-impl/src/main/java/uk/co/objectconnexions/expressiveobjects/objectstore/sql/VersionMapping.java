...
public class VersionMapping {
    ...
    public String insertValues(final DatabaseConnector connector, final Version version) {
        ...
        ExpressiveObjectsContext.getSession().getAuthenticationSession().getUserName();
        String user = ExpressiveObjectsContext.getSession().getAuthenticationSession().getUserName();// version.getUser();
        if (user == "") {
            user = "unknown";
        }
