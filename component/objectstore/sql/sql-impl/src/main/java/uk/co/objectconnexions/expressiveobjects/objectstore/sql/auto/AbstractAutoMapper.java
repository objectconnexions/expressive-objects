...
public abstract class AbstractAutoMapper extends AbstractMapper {
	...
	private static ObjectSpecification specificationFor(final String className) {
		ObjectSpecification specification = ExpressiveObjectsContext.getSpecificationLoader().loadSpecification(className);
    ...
    private void setUpFieldMappers(final FieldMappingLookup lookup, final ObjectMappingLookup objectMappingLookup, final String className, final String parameterBase) {
        final ExpressiveObjectsConfiguration configParameters = getConfiguration();
    ...
    private void setupFullMapping(final FieldMappingLookup lookup, final ObjectMappingLookup objectMapperLookup, final String className, final ExpressiveObjectsConfiguration configParameters, final String parameterBase) {
        ...
        final ExpressiveObjectsConfiguration subset = getConfiguration().createSubset(parameterBase + ".mapper.");
     ...
     * specification, final ExpressiveObjectsConfiguration configParameters, final String
     * parameterBase) { ExpressiveObjectsConfiguration columnMappings =
     * ExpressiveObjectsContext.getConfiguration().createSubset(parameterBase + "column");
     ...
     * }
     * 
     * ExpressiveObjectsConfiguration collectionMappings =
     * ExpressiveObjectsContext.getConfiguration().createSubset( parameterBase +
