 ...
 * 
 *         This common test class is used by all sql objectstore tests to manage the Expressive Objects framework.
 * 
 * @version $Rev$ $Date$
 */
public abstract class SqlIntegrationTestCommonBase {
    ...
    protected boolean persistenceMechanismIs(final String persistenceMechanism) {
        return getProperties().getProperty("expressive-objects.persistor").equals(persistenceMechanism);
    }
