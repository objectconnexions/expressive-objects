...
public class AwtColor implements Color {
    ...
    public AwtColor(final String propertyName, final String defaultColor) {
        ...
        color = ExpressiveObjectsContext.getConfiguration().getColor(PROPERTY_STEM + propertyName, java.awt.Color.decode(defaultColor));
    }

    public AwtColor(final String propertyName, final AwtColor defaultColor) {
        this.name = propertyName;
        color = ExpressiveObjectsContext.getConfiguration().getColor(PROPERTY_STEM + propertyName, defaultColor.getAwtColor());
    }
