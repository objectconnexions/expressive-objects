...
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.base.TextView;
...
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.text.CursorPosition;
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.text.TextBlockTarget;
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.text.TextContent;
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.text.TextSelection;
    ...
    public void firstClick(final Click click) {
        if (canChangeValue().isAllowed()) {
            ...
            if (cursor.getLine() > textContent.getNoLinesOfContent()) {
                throw new ExpressiveObjectsException("not inside content for line " + cursor.getLine() + " : " + textContent.getNoLinesOfContent());
            }
