...
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.util.ViewerException;
...
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.option.OpenViewOption;
...
public abstract class AbstractView implements View {
    ...
    public void addView(final View view) {
        throw new ExpressiveObjectsException("Can't add views to " + this);
    }
