...
public class ViewUpdateNotifierImpl implements ViewUpdateNotifier {
        ...
        if (content != null && content.isObject()) {
            ...
            if (adapter != null) {
                ...
                if (viewsToNotify.contains(view)) {
                    throw new ExpressiveObjectsException(view + " already being notified");
                }
    ...
    public void remove(final View view) {
        ...
        if (object != null) {
            if (!viewListByAdapter.containsKey(object)) {
                throw new ExpressiveObjectsException("Tried to remove a non-existant view " + view + " from observers for " + object);
            }
            ...
            if (viewsToNotify.size() == 0) {
                ...
                // ObjectAdapterLoader loader = ExpressiveObjects.getObjectLoader();
    ...
    private static UpdateNotifier getUpdateNotifier() {
        return ExpressiveObjectsContext.inSession() ? ExpressiveObjectsContext.getUpdateNotifier() : new NoOpUpdateNotifier();
    }
