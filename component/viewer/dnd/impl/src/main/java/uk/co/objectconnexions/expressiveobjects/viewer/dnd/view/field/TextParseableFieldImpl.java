...
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.content.AbstractTextParsableContent;
...
public class TextParseableFieldImpl extends AbstractTextParsableContent implements TextParseableField, ObjectContent {
    ...
    public Consent isEditable() {
        return getValueAssociation().isUsable(ExpressiveObjectsContext.getAuthenticationSession(), getParent(), Where.ANYWHERE);
    }
