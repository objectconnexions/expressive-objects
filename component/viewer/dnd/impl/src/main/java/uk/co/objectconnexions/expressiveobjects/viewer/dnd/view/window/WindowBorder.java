...
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.border.SaveTransientObjectBorder;
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.border.ScrollBorder;
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.option.CloseAllViewsForObjectOption;
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.option.CloseAllViewsOption;
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.option.CloseOtherViewsForObjectOption;
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.option.CloseViewOption;
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.option.IconizeViewOption;
