...
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.service.ServiceObject;
...
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.composite.CompositeViewUsingBuilder;
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.content.FieldContent;
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.look.LookFactory;
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.option.UserActionAbstract;
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.window.DialogBorder;
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.window.SubviewFocusManager;
import uk.co.objectconnexions.expressiveobjects.viewer.dnd.view.window.WindowBorder;
...
public final class ApplicationWorkspace extends CompositeViewUsingBuilder implements Workspace {
    ...
    public void viewMenuOptions(final UserActionSet options) {
        ...
        options.add(new UserActionAbstract("Services...") {
            @Override
            public void execute(final Workspace workspace, final View view, final Location at) {
                final List<Object> servicePojos = ExpressiveObjectsContext.getServices();
