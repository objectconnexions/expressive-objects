...
import uk.co.objectconnexions.expressiveobjects.nof.testsystem.TestProxyConfiguration;
...
public class ColorsAndFontsExample extends Frame {
    ...
    public static void main(final String[] args) {
        ExpressiveObjectsContext.setConfiguration(new TestProxyConfiguration());
