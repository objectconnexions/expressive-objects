...
import uk.co.objectconnexions.expressiveobjects.viewer.html.crumb.CollectionCrumb;
import uk.co.objectconnexions.expressiveobjects.viewer.html.crumb.Crumb;
import uk.co.objectconnexions.expressiveobjects.viewer.html.crumb.ObjectCrumb;
import uk.co.objectconnexions.expressiveobjects.viewer.html.crumb.ObjectFieldCrumb;
import uk.co.objectconnexions.expressiveobjects.viewer.html.crumb.TaskCrumb;
import uk.co.objectconnexions.expressiveobjects.viewer.html.request.Request;
import uk.co.objectconnexions.expressiveobjects.viewer.html.task.Task;
...
public class Context implements Serializable {
    ...
    public void endTask(final Task task) {
        ...
        throw new ExpressiveObjectsException("No crumb found for " + task);
    }
