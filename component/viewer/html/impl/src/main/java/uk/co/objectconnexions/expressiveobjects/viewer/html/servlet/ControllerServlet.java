...
import uk.co.objectconnexions.expressiveobjects.viewer.html.request.ServletRequest;
import uk.co.objectconnexions.expressiveobjects.viewer.html.servlet.internal.WebController;
...
public class ControllerServlet extends AbstractHtmlViewerServlet {
    ...
    private void processRequest(final HttpServletRequest request, final HttpServletResponse response,
        ...
        // no need to check if logged in; the ExpressiveObjectsSessionFilter would
