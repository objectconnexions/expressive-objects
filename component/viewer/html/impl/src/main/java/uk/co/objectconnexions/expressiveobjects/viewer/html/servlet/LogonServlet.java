...
import uk.co.objectconnexions.expressiveobjects.viewer.html.component.html.LogonFormPage;
...
public class LogonServlet extends AbstractHtmlViewerServlet {
    ...
    public void init() throws ServletException {
        authenticationSessionStrategy = ExpressiveObjectsSessionFilter.lookup(getServletConfig().getInitParameter(ExpressiveObjectsSessionFilter.AUTHENTICATION_SESSION_STRATEGY_KEY));
    }
