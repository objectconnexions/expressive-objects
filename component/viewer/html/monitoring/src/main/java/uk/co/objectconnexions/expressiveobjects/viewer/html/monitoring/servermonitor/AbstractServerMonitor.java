...
package uk.co.objectconnexions.expressiveobjects.viewer.html.monitoring.servermonitor;
...
import uk.co.objectconnexions.expressiveobjects.core.runtime.services.InitialisationException;
...
public abstract class AbstractServerMonitor {
    ...
    public void listen() {
        final String hostAddress = ExpressiveObjectsContext.getConfiguration().getString(ADDRESS);
        InetAddress address;
        try {
    ...
    public abstract void setTarget(ExpressiveObjectsSystem system);
