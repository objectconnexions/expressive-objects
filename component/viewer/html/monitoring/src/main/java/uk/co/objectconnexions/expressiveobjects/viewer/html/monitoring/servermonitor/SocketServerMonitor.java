...
public class SocketServerMonitor extends AbstractServerMonitor {
    ...
    private ExpressiveObjectsSystem system;

    @Override
    protected int getPort() {
        return ExpressiveObjectsContext.getConfiguration().getInteger(PORT, DEFAULT_PORT);
    }
    ...
    @Override
    public void setTarget(final ExpressiveObjectsSystem system) {
        this.system = system;
    }
}
