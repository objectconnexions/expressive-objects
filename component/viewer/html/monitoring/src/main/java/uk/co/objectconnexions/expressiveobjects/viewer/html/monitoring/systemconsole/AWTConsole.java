...
package uk.co.objectconnexions.expressiveobjects.viewer.html.monitoring.systemconsole;
...
public class AWTConsole extends Frame implements ServerConsole {
    ...
    public static final String WIDTH = "expressive-objects.awt-console.width";
    public static final String HEIGHT = "expressive-objects.awt-console.height";
    ...
    private void buildGUI() {
        ...
        frameSize.width = ExpressiveObjectsContext.getConfiguration().getInteger(WIDTH, DEFAULT_WIDTH);
        frameSize.height = ExpressiveObjectsContext.getConfiguration().getInteger(HEIGHT, DEFAULT_HEIGHT);
