...
public final class Constants {
    ...
    public static final String EXPRESSIVE_OBJECTS_REST_SUPPORT_JS = "expressive-objects-rest-support.js";
    public static final String JQUERY_SRC_JS = "jquery-1.6.1.js";
    public static final String JQUERY_MIN_JS = "jquery-1.6.1.min.js";
    public static final String URL_ENCODING_CHAR_SET = uk.co.objectconnexions.expressiveobjects.viewer.restfulobjects.applib.Constants.URL_ENCODING_CHAR_SET;
