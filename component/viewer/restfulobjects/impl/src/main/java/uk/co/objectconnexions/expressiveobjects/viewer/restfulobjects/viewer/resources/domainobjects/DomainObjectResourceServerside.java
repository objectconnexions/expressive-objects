...
import uk.co.objectconnexions.expressiveobjects.viewer.restfulobjects.viewer.resources.domainobjects.DomainResourceHelper.Intent;
import uk.co.objectconnexions.expressiveobjects.viewer.restfulobjects.viewer.resources.domainobjects.DomainResourceHelper.MemberMode;
...
public class DomainObjectResourceServerside extends ResourceAbstract implements DomainObjectResource {
    ...
    public Response object(@PathParam("oid") final String oidStr, final InputStream object) {
        ...
        final ExpressiveObjectsTransactionManager transactionManager = getResourceContext().getPersistenceSession().getTransactionManager();
