 ...
 *  under the License.
 */
package uk.co.objectconnexions.expressiveobjects.viewer.restfulobjects.viewer.resources.version;
...
public class VersionReprRenderer extends ReprRendererAbstract<VersionReprRenderer, Void> {
    ...
    private static final String META_INF_POM_PROPERTIES = "/META-INF/maven/uk.co.objectconnexions.expressiveobjects.viewer/restfulobjects-viewer/pom.properties";
