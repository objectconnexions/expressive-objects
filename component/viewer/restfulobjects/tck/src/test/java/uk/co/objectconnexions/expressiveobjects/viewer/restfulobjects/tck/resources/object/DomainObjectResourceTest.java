 ...
 *  under the License.
 */
package uk.co.objectconnexions.expressiveobjects.viewer.restfulobjects.tck.resources.object;
...
import uk.co.objectconnexions.expressiveobjects.core.tck.dom.refs.BidirWithSetChildEntity;
import uk.co.objectconnexions.expressiveobjects.core.tck.dom.scalars.ApplibValuedEntity;
import uk.co.objectconnexions.expressiveobjects.core.tck.dom.scalars.ApplibValuedEntityRepository;
...
import uk.co.objectconnexions.expressiveobjects.viewer.restfulobjects.domainobjects.ActionResultRepresentation.ResultType;
...
public class DomainObjectResourceTest {
    ...
    public void actionPostInvoke_returningList() throws Exception {
        ...
        assertThat(domainObjectTypeLink.getHref(), matches("http://localhost:\\d+/types/application/vnd." + uk.co.objectconnexions.expressiveobjects.core.tck.dom.scalars.ApplibValuedEntity.class.getName() + "\\+json"));
