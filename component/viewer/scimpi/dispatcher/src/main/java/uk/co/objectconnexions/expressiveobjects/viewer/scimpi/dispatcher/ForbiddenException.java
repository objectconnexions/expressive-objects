...
public class ForbiddenException extends ScimpiException {
    ...
    public ForbiddenException(final String message) {
        this(ExpressiveObjectsContext.getAuthenticationSession(), message);
    }
    ...
    public ForbiddenException(final IdentifiedHolder target, final boolean isVisibleAndUsabable) {
        this(target.getIdentifier(), ExpressiveObjectsContext.getAuthenticationSession(), isVisibleAndUsabable);
    }
