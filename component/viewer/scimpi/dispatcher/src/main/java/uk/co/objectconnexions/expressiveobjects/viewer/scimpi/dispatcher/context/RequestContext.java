...
import uk.co.objectconnexions.expressiveobjects.viewer.scimpi.dispatcher.ErrorCollator;
import uk.co.objectconnexions.expressiveobjects.viewer.scimpi.dispatcher.ScimpiException;
import uk.co.objectconnexions.expressiveobjects.viewer.scimpi.dispatcher.action.PropertyException;
...
public abstract class RequestContext {
    ...
    public RequestContext(final DebugUsers debugUsers) {
        ...
        String className = ExpressiveObjectsContext.getConfiguration().getString("scimpi.object-mapping.class", DefaultOidObjectMapping.class.getName());
        objectMapping = InstanceUtil.createInstance(className, ObjectMapping.class);
        className = ExpressiveObjectsContext.getConfiguration().getString("scimpi.version-mapping.class", DefaultVersionMapping.class.getName());
