...
public class HelpLink extends AbstractElementProcessor {
    ...
    public static String createHelpSegment(final String description, final String helpReference) {
        if (site == null) {
            site = ExpressiveObjectsContext.getConfiguration().getString(ConfigurationConstants.ROOT + "scimpi.help-site", "/help/");
        }
        if (suffix == null) {
            suffix = ExpressiveObjectsContext.getConfiguration().getString(ConfigurationConstants.ROOT + "scimpi.help-suffix", "shtml");
