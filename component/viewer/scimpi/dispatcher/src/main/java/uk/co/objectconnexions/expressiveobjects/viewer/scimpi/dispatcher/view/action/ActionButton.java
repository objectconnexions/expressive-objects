...
public class ActionButton extends AbstractElementProcessor {
    ...
    public void process(final Request request) {
        ...
        if (showMessage) {
            final Consent usable = action.isUsable(ExpressiveObjectsContext.getAuthenticationSession(), object, where);
            if (usable.isVetoed()) {
    ...
    public static void write(
        ...
        if (action.isVisible(ExpressiveObjectsContext.getAuthenticationSession(), object, where).isVetoed()) {
