...
public abstract class AbstractConditionalBlock extends AbstractElementProcessor {
    ...
    public void process(final Request request) {
         ...
         * objectAction.isVisible(ExpressiveObjectsContext.getAuthenticationSession(),
         ...
         * objectAction.isUsable(ExpressiveObjectsContext.getAuthenticationSession(),
         ...
         * Consent visible =
         * objectField.isVisible(ExpressiveObjectsContext.getAuthenticationSession(),
         * object); checkMade = true; allConditionsMet &= visible.isAllowed(); }
         * 
         ...
         * objectField = object.getSpecification().getAssociation(field);
         * Consent usable =
         * objectField.isUsable(ExpressiveObjectsContext.getAuthenticationSession(), object);
         ...
         * MethodsUtils.findObject(request.getContext(), id); ObjectAssociation
         * objectField = object.getSpecification().getAssociation(field);
         * ExpressiveObjectsContext.getPersistenceSession().resolveField(object,
         ...
         * ExpressiveObjectsContext.getSession().getAuthenticationSession(); List<String>
...
class TestMethodVisible extends Test {
    ...
    boolean test(final Request request, final String attributeName, final String targetId) {
        ...
        final Consent visible = objectAction.isVisible(ExpressiveObjectsContext.getAuthenticationSession(), object, Where.ANYWHERE);
...
class TestFieldVisible extends Test {
    ...
    boolean test(final Request request, final String attributeName, final String targetId) {
        ...
        final Consent visible = objectField.isVisible(ExpressiveObjectsContext.getAuthenticationSession(), object, Where.ANYWHERE);
        return visible.isAllowed();
    }
}
...
class TestFieldEditable extends Test {
    ...
    boolean test(final Request request, final String attributeName, final String targetId) {
        final ObjectAdapter object = MethodsUtils.findObject(request.getContext(), targetId);
        final ObjectAssociation objectField = findProperty(attributeName, object);
        final Consent usable = objectField.isUsable(ExpressiveObjectsContext.getAuthenticationSession(), object, Where.ANYWHERE);
        return usable.isAllowed();
    }
}
...
class TestHasRole extends Test {
    ...
    boolean test(final Request request, final String attributeName, final String targetId) {
        ...
        final AuthenticationSession session = ExpressiveObjectsContext.getSession().getAuthenticationSession();
