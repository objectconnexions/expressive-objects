 ...
 * 
 * <p>
 * The {@link uk.co.objectconnexions.expressiveobjects.applib.adapters.ValueSemanticsProvider} interface
 * allows the framework to recognize its corresponding type as being a value
 * type (that is, having value semantics).  The {@link uk.co.objectconnexions.expressiveobjects.applib.adapters.AbstractValueSemanticsProvider}
 * class is an base adapter for this interface. 
 * 
 * <p>
 * The association between {@link uk.co.objectconnexions.expressiveobjects.applib.adapters.ValueSemanticsProvider}
 * and its corresponding type can be done in several ways.  Most straightforward
 * is to annotate the class with the {@link uk.co.objectconnexions.expressiveobjects.applib.annotation.Value}
