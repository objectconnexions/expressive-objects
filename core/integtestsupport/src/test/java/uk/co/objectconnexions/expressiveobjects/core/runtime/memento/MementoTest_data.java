...
import uk.co.objectconnexions.expressiveobjects.core.runtime.memento.Data;
import uk.co.objectconnexions.expressiveobjects.core.runtime.memento.Memento;
import uk.co.objectconnexions.expressiveobjects.core.runtime.memento.ObjectData;
...
public class MementoTest_data {
    ...
    public void setUpSystem() throws Exception {
        ...
        originalAdapter1 = ExpressiveObjectsContext.getPersistenceSession().getAdapterManager().adapterFor(iswf.fixtures.wve1);
        ...
        originalAdapter2 = ExpressiveObjectsContext.getPersistenceSession().getAdapterManager().adapterFor(iswf.fixtures.wve2);
