 ...
 * 
 * <p>
 * The <i>default runtime</i> (<tt>uk.co.objectconnexions.expressiveobjects.runtimes.dflt</tt> module),
...
public interface Installer extends ApplicationScopedComponent {
     ...
     * <tt>expressive-objects.persistor</tt> or <tt>expressive-objects.persistor.in-memory</tt>.
     * 
     * <p>
