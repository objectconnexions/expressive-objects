...
package uk.co.objectconnexions.expressiveobjects.core.commons.encoding;
...
public final class HexUtils {
    ...
    public static String encoded(final Object object) {
        ...
        try {
            ...
            throw new ExpressiveObjectsException("Failed to write object", e);
        }
    }
    ...
    public static <T> T decoded(final String hexEncoded, Class<T> cls) {
        ...
        try {
            ...
            throw new ExpressiveObjectsException("Failed to read object", ex);
        } catch (final DecoderException ex) {
            throw new ExpressiveObjectsException("Failed to hex decode object", ex);
        }
    }
