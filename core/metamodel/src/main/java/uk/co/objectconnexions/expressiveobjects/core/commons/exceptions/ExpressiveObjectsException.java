...
package uk.co.objectconnexions.expressiveobjects.core.commons.exceptions;
 ...
 */
public class ExpressiveObjectsException extends RuntimeException {
    ...
    public ExpressiveObjectsException() {
        super("");
        cause = null;
    }

    public ExpressiveObjectsException(final String message) {
        super(message);
        cause = null;
    }

    public ExpressiveObjectsException(final String messageFormat, final Object... args) {
        super(MessageFormat.format(messageFormat, args));
        cause = null;
    }

    public ExpressiveObjectsException(final String message, final Throwable cause) {
        super(message);
        this.cause = cause;
    }

    public ExpressiveObjectsException(final Throwable cause) {
