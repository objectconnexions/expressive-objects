...
import static uk.co.objectconnexions.expressiveobjects.core.metamodel.adapter.ResolveState.RepresentsPersistent.DOES_NOT_REPRESENT_PERSISTENT;
import static uk.co.objectconnexions.expressiveobjects.core.metamodel.adapter.ResolveState.RepresentsPersistent.REPRESENTS_PERSISTENT;
import static uk.co.objectconnexions.expressiveobjects.core.metamodel.adapter.ResolveState.RespondsToChanges.DOES_NOT_RESPOND_TO_CHANGES;
import static uk.co.objectconnexions.expressiveobjects.core.metamodel.adapter.ResolveState.RespondsToChanges.RESPONDS_TO_CHANGES;
import static uk.co.objectconnexions.expressiveobjects.core.metamodel.adapter.ResolveState.TransitionFrom.CANNOT_TRANSITION_FROM;
import static uk.co.objectconnexions.expressiveobjects.core.metamodel.adapter.ResolveState.TransitionFrom.CAN_TRANSITION_FROM;
