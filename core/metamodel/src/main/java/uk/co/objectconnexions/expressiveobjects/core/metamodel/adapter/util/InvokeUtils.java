...
package uk.co.objectconnexions.expressiveobjects.core.metamodel.adapter.util;
...
import uk.co.objectconnexions.expressiveobjects.core.commons.lang.WrapperUtils;
...
public class InvokeUtils {
    ...
    public static void invocationException(final String error, final InvocationTargetException e) {
        ...
        if (targetException instanceof ApplicationException) {
            ...
            // ExpressiveObjectsException with same semantics
            throw new ExpressiveObjectsApplicationException(targetException);
        }
