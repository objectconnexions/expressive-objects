...
package uk.co.objectconnexions.expressiveobjects.core.metamodel.facetapi;
...
public interface MetaModelValidatorRefiner {
    ...
    void refineMetaModelValidator(MetaModelValidatorComposite metaModelValidator, ExpressiveObjectsConfiguration configuration);
