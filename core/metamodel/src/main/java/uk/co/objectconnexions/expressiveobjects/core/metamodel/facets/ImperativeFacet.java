...
public interface ImperativeFacet {
    ...
    /**
     * For use by
     * {@link FacetHolder#getFacets(uk.co.objectconnexions.expressiveobjects.core.metamodel.facetapi.progmodel.facets.uk.co.objectconnexions.expressiveobjects.nof.arch.facets.Facet.Filter)}
     */
