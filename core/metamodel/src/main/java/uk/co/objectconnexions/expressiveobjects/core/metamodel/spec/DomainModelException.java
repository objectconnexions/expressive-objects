...
/**
 * Thrown when a problem is found with the domain model, and Expressive Objects cannot
 * proceed.
 */
public class DomainModelException extends ExpressiveObjectsException {
