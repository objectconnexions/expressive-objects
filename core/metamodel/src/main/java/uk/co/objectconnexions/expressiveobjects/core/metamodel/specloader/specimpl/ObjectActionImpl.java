...
import uk.co.objectconnexions.expressiveobjects.core.metamodel.interactions.ActionUsabilityContext;
import uk.co.objectconnexions.expressiveobjects.core.metamodel.interactions.ActionVisibilityContext;
...
public class ObjectActionImpl extends ObjectMemberAbstract implements ObjectAction {
    ...
    private ObjectAdapter findService() {
        ...
        throw new ExpressiveObjectsException("failed to find service for action " + this.getName());
    }
