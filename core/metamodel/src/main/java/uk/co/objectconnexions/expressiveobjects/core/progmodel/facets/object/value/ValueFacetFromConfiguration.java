...
public class ValueFacetFromConfiguration extends ValueFacetAbstract {
    ...
    public ValueFacetFromConfiguration(final String candidateSemanticsProviderName, final FacetHolder holder, final ExpressiveObjectsConfiguration configuration, final ValueSemanticsProviderContext context) {
