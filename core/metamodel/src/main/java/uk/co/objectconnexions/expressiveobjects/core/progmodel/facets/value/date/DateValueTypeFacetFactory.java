...
public class DateValueTypeFacetFactory extends ValueUsingValueSemanticsProviderFacetFactory<uk.co.objectconnexions.expressiveobjects.applib.value.Date> {
    ...
    public void process(final ProcessClassContext processClassContext) {
        ...
        if (type != uk.co.objectconnexions.expressiveobjects.applib.value.Date.class) {
            return;
        }
