...
public class DateTimeValueTypeFacetFactory extends ValueUsingValueSemanticsProviderFacetFactory<uk.co.objectconnexions.expressiveobjects.applib.value.DateTime> {
    ...
    public void process(final ProcessClassContext processClassContext) {
        ...
        if (type != uk.co.objectconnexions.expressiveobjects.applib.value.DateTime.class) {
            return;
        }
