...
public class ImageValueTypeFacetFactory extends ValueUsingValueSemanticsProviderFacetFactory<uk.co.objectconnexions.expressiveobjects.applib.value.Image> {
    ...
    public void process(final ProcessClassContext processClassContext) {
        ...
        if (type != uk.co.objectconnexions.expressiveobjects.applib.value.Image.class) {
            return;
        }
