...
public class LongWrapperValueSemanticsProvider extends LongValueSemanticsProviderAbstract {
    ...
    public LongWrapperValueSemanticsProvider(final FacetHolder holder, final ExpressiveObjectsConfiguration configuration, final ValueSemanticsProviderContext context) {
