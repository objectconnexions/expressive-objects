...
public class ShortWrapperValueSemanticsProvider extends ShortValueSemanticsProviderAbstract {
    ...
    public ShortWrapperValueSemanticsProvider(final FacetHolder holder, final ExpressiveObjectsConfiguration configuration, final ValueSemanticsProviderContext context) {
