...
public class TimeValueTypeFacetFactory extends ValueUsingValueSemanticsProviderFacetFactory<uk.co.objectconnexions.expressiveobjects.applib.value.Time> {
    ...
    public void process(final ProcessClassContext processClassContext) {
        ...
        if (type != uk.co.objectconnexions.expressiveobjects.applib.value.Time.class) {
            return;
        }
