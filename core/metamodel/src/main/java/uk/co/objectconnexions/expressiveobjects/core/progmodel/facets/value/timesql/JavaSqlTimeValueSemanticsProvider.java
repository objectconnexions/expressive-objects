...
package uk.co.objectconnexions.expressiveobjects.core.progmodel.facets.value.timesql;
...
import uk.co.objectconnexions.expressiveobjects.core.progmodel.facets.value.time.TimeValueSemanticsProviderAbstract;
...
public class JavaSqlTimeValueSemanticsProvider extends TimeValueSemanticsProviderAbstract<java.sql.Time> {
    ...
    public JavaSqlTimeValueSemanticsProvider(final FacetHolder holder, final ExpressiveObjectsConfiguration configuration, final ValueSemanticsProviderContext context) {
