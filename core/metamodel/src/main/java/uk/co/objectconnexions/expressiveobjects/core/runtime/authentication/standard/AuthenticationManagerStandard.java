...
public class AuthenticationManagerStandard implements AuthenticationManager, DebuggableWithTitle {
    ...
    public AuthenticationManagerStandard(final ExpressiveObjectsConfiguration configuration) {
    ...
    public final void init() {
        ...
        if (authenticators.size() == 0) {
            throw new ExpressiveObjectsException("No authenticators specified");
        }
