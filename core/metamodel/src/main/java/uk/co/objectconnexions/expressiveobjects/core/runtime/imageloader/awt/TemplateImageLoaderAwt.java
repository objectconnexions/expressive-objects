...
package uk.co.objectconnexions.expressiveobjects.core.runtime.imageloader.awt;
...
import uk.co.objectconnexions.expressiveobjects.core.runtime.imageloader.TemplateImageImpl;
...
public class TemplateImageLoaderAwt implements TemplateImageLoader {
    ...
    public TemplateImageLoaderAwt(final ExpressiveObjectsConfiguration configuration) {
    ...
    private ExpressiveObjectsConfiguration getConfiguration() {
