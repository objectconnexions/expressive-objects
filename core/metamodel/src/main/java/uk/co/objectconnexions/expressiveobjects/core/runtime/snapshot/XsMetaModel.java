...
public final class XsMetaModel {
    ...
    Element createXsSchemaElement(final Document xsdDoc) {
        ...
        xsImportElement.setAttribute("namespace", ExpressiveObjectsSchema.NS_URI);
        xsImportElement.setAttribute("schemaLocation", ExpressiveObjectsSchema.DEFAULT_LOCATION);
    ...
    Element addXsNofAttribute(final Element parentXsElement, final String nofAttributeRef, final String value, final boolean useFixed) {
        ...
        xsNofAttributeElement.setAttribute("ref", ExpressiveObjectsSchema.NS_PREFIX + ":" + nofAttributeRef);
