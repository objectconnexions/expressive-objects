...
package uk.co.objectconnexions.expressiveobjects.core.runtime.sysout;
...
public class SystemPrinter {
    ...
    public void printDiagnostics() {
        print("------- Expressive Objects diagnostics report -------");
        printVersion();
    ...
    public void printVersion() {
        final String date = AboutExpressiveObjects.getFrameworkCompileDate();
        final String compileDate = date == null ? "" : ", compiled on " + date;
        print(AboutExpressiveObjects.getFrameworkName() + ", " + AboutExpressiveObjects.getFrameworkVersion() + compileDate);
    }
