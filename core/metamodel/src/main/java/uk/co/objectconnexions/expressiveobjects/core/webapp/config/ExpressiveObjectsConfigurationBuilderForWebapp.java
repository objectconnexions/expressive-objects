...
import uk.co.objectconnexions.expressiveobjects.core.commons.config.ExpressiveObjectsConfigurationBuilderFileSystem;
 ...
 */
public class ExpressiveObjectsConfigurationBuilderForWebapp extends ExpressiveObjectsConfigurationBuilderResourceStreams {

    @SuppressWarnings("unused")
    private static final Logger LOG = Logger.getLogger(ExpressiveObjectsConfigurationBuilderFileSystem.class);

    public ExpressiveObjectsConfigurationBuilderForWebapp(final ServletContext servletContext) {
