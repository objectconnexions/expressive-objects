...
import uk.co.objectconnexions.expressiveobjects.core.metamodel.specloader.classsubstitutor.ClassSubstitutorComposite;
...
public class JavaReflectorInstallerNoDecorators extends InstallerAbstract implements ObjectReflectorInstaller {
     ...
     * exclude.
     */
    protected ProgrammingModel createProgrammingModel(final ExpressiveObjectsConfiguration configuration) {
    ...
    private ProgrammingModel lookupAndCreateProgrammingModelFacets(final ExpressiveObjectsConfiguration configuration) {
    ...
    /**
     * Factored out of {@link #createProgrammingModel(ExpressiveObjectsConfiguration)}
     ...
     */
    protected void includeFacetFactories(final ExpressiveObjectsConfiguration configuration, final ProgrammingModel programmingModel) {
     ...
     * customization of their {@link ProgrammingModel} in a similar way.
     */
    protected void excludeFacetFactories(final ExpressiveObjectsConfiguration configuration, final ProgrammingModel programmingModel) {
     ...
     */
    protected MetaModelValidator createMetaModelValidator(final ExpressiveObjectsConfiguration configuration) {
