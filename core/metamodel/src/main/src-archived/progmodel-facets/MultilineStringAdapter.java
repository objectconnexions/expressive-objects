...
import uk.co.objectconnexions.expressiveobjects.applib.value.MultilineString;
import uk.co.objectconnexions.expressiveobjects.noa.adapter.value.MultilineStringValue;
import uk.co.objectconnexions.expressiveobjects.nof.core.adapter.value.AbstractValueAdapter;
import uk.co.objectconnexions.expressiveobjects.nof.core.util.ToString;
