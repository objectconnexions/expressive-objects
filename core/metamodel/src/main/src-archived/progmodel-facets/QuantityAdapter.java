...
package uk.co.objectconnexions.expressiveobjects.progmodel.java5.value;

import uk.co.objectconnexions.expressiveobjects.applib.value.Quantity;
import uk.co.objectconnexions.expressiveobjects.noa.adapter.TextEntryParseException;
import uk.co.objectconnexions.expressiveobjects.noa.adapter.value.IntegerValue;
import uk.co.objectconnexions.expressiveobjects.nof.core.adapter.value.AbstractValueAdapter;
import uk.co.objectconnexions.expressiveobjects.nof.core.conf.Configuration;
...
public class QuantityAdapter extends AbstractValueAdapter implements IntegerValue {
    ...
    public QuantityAdapter() {
        this.quantity = null;
        String formatRequired = ExpressiveObjectsContext.getConfiguration().getString(Configuration.ROOT + "value.format.quantity");
