...
public class ConfigurationBuilderTwoDirectoriesTest extends TestCase {
    ExpressiveObjectsConfigurationBuilderFileSystem builder;

    @Override
    protected void setUp() throws Exception {
        Logger.getRootLogger().setLevel(Level.OFF);
        builder = new ExpressiveObjectsConfigurationBuilderFileSystem("src/test/config", "src/test");
    }
    ...
    public void testAddConfigurationInDifferentDirectory() throws Exception {
        ...
        final ExpressiveObjectsConfiguration configuration = builder.getConfiguration();
