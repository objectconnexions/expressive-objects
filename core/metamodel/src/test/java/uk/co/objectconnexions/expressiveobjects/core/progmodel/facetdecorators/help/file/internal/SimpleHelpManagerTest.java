...
public class SimpleHelpManagerTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        manager = new TestHelpManager(new ExpressiveObjectsConfigurationDefault());
    }
    ...
    public void testMessageForFileError() {
        final Identifier identifier = Identifier.propertyOrCollectionIdentifier("cls", "fld2");
        final HelpManagerUsingFiles manager = new HelpManagerUsingFiles(new ExpressiveObjectsConfigurationDefault()) {
            @Override
...
class TestHelpManager extends HelpManagerUsingFiles {
    public TestHelpManager(final ExpressiveObjectsConfiguration configuration) {
        super(configuration);
    }
