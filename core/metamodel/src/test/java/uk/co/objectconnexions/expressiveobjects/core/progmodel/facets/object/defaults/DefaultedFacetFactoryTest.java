...
public class DefaultedFacetFactoryTest extends AbstractFacetFactoryTest {
    ...
    @Defaulted(defaultsProviderName = "uk.co.objectconnexions.expressiveobjects.core.progmodel.facets.object.defaults.DefaultedFacetFactoryTest$MyDefaultedUsingDefaultsProvider")
    ...
    public void testDefaultedProviderNameCanBePickedUpFromConfiguration() {
        final String className = "uk.co.objectconnexions.expressiveobjects.core.progmodel.facets.object.defaults.DefaultedFacetFactoryTest$MyDefaultedWithDefaultsProviderSpecifiedUsingConfiguration";
        expressiveObjectsConfigurationDefault.add(DefaultsProviderUtil.DEFAULTS_PROVIDER_NAME_KEY_PREFIX + canonical(className) + DefaultsProviderUtil.DEFAULTS_PROVIDER_NAME_KEY_SUFFIX, className);
    ...
    public void testNonAnnotatedDefaultedCanBePickedUpFromConfiguration() {
        final String className = "uk.co.objectconnexions.expressiveobjects.core.progmodel.facets.object.defaults.DefaultedFacetFactoryTest$NonAnnotatedDefaultedDefaultsProviderSpecifiedUsingConfiguration";
        expressiveObjectsConfigurationDefault.add(DefaultsProviderUtil.DEFAULTS_PROVIDER_NAME_KEY_PREFIX + canonical(className) + DefaultsProviderUtil.DEFAULTS_PROVIDER_NAME_KEY_SUFFIX, className);
