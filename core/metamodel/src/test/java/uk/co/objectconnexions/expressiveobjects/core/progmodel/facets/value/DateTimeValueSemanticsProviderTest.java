...
import uk.co.objectconnexions.expressiveobjects.core.progmodel.facets.value.datetime.DateTimeValueSemanticsProvider;
...
public class DateTimeValueSemanticsProviderTest extends ValueSemanticsProviderAbstractTestCase {
    ...
    public void setUpObjects() throws Exception {
        context.checking(new Expectations() {
            {
                allowing(mockConfiguration).getString("expressive-objects.value.format.datetime");
    ...
    public void testEntryWithShortFormat() {
        final String entry = hasJavaChangedDateFormat() ? "21/5/2007, 10:30" : "21/5/2007 10:30";
        final int year = 2007;
        final int month = 5;
        final int day = 21;
        final int hour = 10;
