...
import uk.co.objectconnexions.expressiveobjects.core.progmodel.facets.value.timestampsql.JavaSqlTimeStampValueSemanticsProvider;
...
public class JavaSqlTimeStampValueSemanticsProviderTest extends ValueSemanticsProviderAbstractTestCase {
    ...
    public void testTitle() {
        String date = hasJavaChangedDateFormat() ? "01/01/1970, 00:00:00 UTC" : "01/01/70 00:00:00 UTC";
        assertEquals(date, adapter.titleString(timestamp, null)); 
    }
