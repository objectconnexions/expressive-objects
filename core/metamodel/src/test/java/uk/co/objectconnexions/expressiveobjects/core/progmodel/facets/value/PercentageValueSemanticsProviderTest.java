...
import uk.co.objectconnexions.expressiveobjects.core.progmodel.facets.value.percentage.PercentageValueSemanticsProvider;
...
public class PercentageValueSemanticsProviderTest extends ValueSemanticsProviderAbstractTestCase {
    ...
    public void setUpObjects() throws Exception {
        context.checking(new Expectations() {
            {
                allowing(mockConfiguration).getString("expressive-objects.value.format.percentage");
