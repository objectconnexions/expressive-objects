...
package uk.co.objectconnexions.expressiveobjects.core.profilestore;
...
public class InMemoryUserProfileStoreInstaller extends InstallerAbstract implements UserProfileStoreInstaller {
    ...
    @Override
    public UserProfileStore createUserProfileStore(final ExpressiveObjectsConfiguration objectConfiguration) {
