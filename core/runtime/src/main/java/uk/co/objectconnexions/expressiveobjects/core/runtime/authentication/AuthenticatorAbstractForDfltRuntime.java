...
public abstract class AuthenticatorAbstractForDfltRuntime extends AuthenticatorAbstract {
    ...
    public AuthenticatorAbstractForDfltRuntime(final ExpressiveObjectsConfiguration configuration) {
        super(configuration);
    }
    ...
    public DeploymentType getDeploymentType() {
        ...
        if (deploymentTypeStr == null) {
            throw new IllegalStateException("Expect value for '" + SystemConstants.DEPLOYMENT_TYPE_KEY + "' to be bound into ExpressiveObjectsConfiguration");
        }
