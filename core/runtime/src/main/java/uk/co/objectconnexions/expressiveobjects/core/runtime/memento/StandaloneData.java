...
public class StandaloneData extends Data {
    ...
    public ObjectAdapter getAdapter() {
        if (objectAsSerializable != null) {
            return ExpressiveObjectsContext.getPersistenceSession().getAdapterManager().adapterFor(objectAsSerializable);
        } else {
            final ObjectSpecification spec = ExpressiveObjectsContext.getSpecificationLoader().loadSpecification(getClassName());
