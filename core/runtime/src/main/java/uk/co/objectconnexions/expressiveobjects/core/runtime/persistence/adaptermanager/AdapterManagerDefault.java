...
import uk.co.objectconnexions.expressiveobjects.core.metamodel.facets.typeof.ElementSpecificationProviderFromTypeOfFacet;
...
public class AdapterManagerDefault implements AdapterManagerSpi {
    ...
    public void remapAsPersistent(final ObjectAdapter adapter, RootOid hintRootOid) {
        ...
        if(hintRootOid != null) {
            if(hintRootOid.isTransient()) {
                throw new ExpressiveObjectsAssertException("hintRootOid must be persistent");
            }
            ...
            if(!hintRootOidObjectSpecId.equals(adapterObjectSpecId)) {
                throw new ExpressiveObjectsAssertException("hintRootOid's objectType must be same as that of adapter " +
    ...
    public OidGenerator getOidGenerator() {
        return ExpressiveObjectsContext.getPersistenceSession().getOidGenerator();
    }
    ...
    protected ServicesInjector getServicesInjector() {
        return ExpressiveObjectsContext.getPersistenceSession().getServicesInjector();
    }
