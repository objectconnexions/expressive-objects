...
import static uk.co.objectconnexions.expressiveobjects.core.runtime.runner.Constants.ADDITIONAL_PROPERTY;
...
public class OptionHandlerAdditionalProperty extends OptionHandlerAbstract {
    ...
    public void primeConfigurationBuilder(final ExpressiveObjectsConfigurationBuilder expressiveObjectsConfigurationBuilder) {
        addConfigurationProperties(expressiveObjectsConfigurationBuilder, additionalProperties);
    }

    private void addConfigurationProperties(final ExpressiveObjectsConfigurationBuilder expressiveObjectsConfigurationBuilder, final List<String> additionalProperties) {
        ...
        for (final String additionalProperty : additionalProperties) {
            if (key == null) {
                ...
                expressiveObjectsConfigurationBuilder.add(key, value);
                key = null;
            }
        }
    }
