...
import static uk.co.objectconnexions.expressiveobjects.core.runtime.runner.Constants.FIXTURE_LONG_OPT;
import static uk.co.objectconnexions.expressiveobjects.core.runtime.runner.Constants.FIXTURE_OPT;
...
public class OptionHandlerFixture extends OptionHandlerAbstract {
    ...
    public void primeConfigurationBuilder(final ExpressiveObjectsConfigurationBuilder expressiveObjectsConfigurationBuilder) {
        expressiveObjectsConfigurationBuilder.add(SystemConstants.FIXTURE_KEY, fixture);
    }
