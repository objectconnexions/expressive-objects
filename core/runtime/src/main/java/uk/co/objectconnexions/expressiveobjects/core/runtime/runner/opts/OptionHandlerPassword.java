...
import static uk.co.objectconnexions.expressiveobjects.core.runtime.runner.Constants.PASSWORD_LONG_OPT;
import static uk.co.objectconnexions.expressiveobjects.core.runtime.runner.Constants.PASSWORD_OPT;
...
public class OptionHandlerPassword extends OptionHandlerAbstract {
    ...
    public void primeConfigurationBuilder(final ExpressiveObjectsConfigurationBuilder expressiveObjectsConfigurationBuilder) {
        expressiveObjectsConfigurationBuilder.add(SystemConstants.PASSWORD_KEY, password);
    }
