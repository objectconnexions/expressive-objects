...
import static uk.co.objectconnexions.expressiveobjects.core.runtime.runner.Constants.USER_LONG_OPT;
import static uk.co.objectconnexions.expressiveobjects.core.runtime.runner.Constants.USER_OPT;
...
public class OptionHandlerUser extends OptionHandlerAbstract {
    ...
    public void primeConfigurationBuilder(final ExpressiveObjectsConfigurationBuilder expressiveObjectsConfigurationBuilder) {
        expressiveObjectsConfigurationBuilder.add(SystemConstants.USER_KEY, userName);
    }
