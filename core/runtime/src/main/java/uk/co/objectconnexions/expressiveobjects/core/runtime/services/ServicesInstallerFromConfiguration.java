...
public class ServicesInstallerFromConfiguration extends InstallerAbstract implements ServicesInstaller {
    ...
    private void appendServices(final ExpressiveObjectsConfiguration configuration, final String group, List<Object> listOfServices) {
    ...
    private void appendObjectFixtureService(final ExpressiveObjectsConfiguration configuration, final String root, List<Object> serviceList) {
