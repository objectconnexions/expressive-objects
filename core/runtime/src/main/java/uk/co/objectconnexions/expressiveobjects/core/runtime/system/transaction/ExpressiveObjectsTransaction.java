...
/**
 * Used by the {@link ExpressiveObjectsTransactionManager} to captures a set of changes to be
 * applied.
 * 
 * <p>
 * The protocol by which the {@link ExpressiveObjectsTransactionManager} interacts and uses
 * the {@link ExpressiveObjectsTransaction} is not API, because different approaches are
 ...
 * is through the {@link ExpressiveObjectsTransactionManager transaction manager}, because
 * some implementations may support nesting and such like. It is also the job of
 * the {@link ExpressiveObjectsTransactionManager} to ensure that the underlying persistence
 * mechanism (for example, the <tt>ObjectAdapterStore</tt>) is also committed.
 */
public class ExpressiveObjectsTransaction implements TransactionScopedComponent {
    ...
    public static enum State {
         ...
         * 
         * <p>
         * May {@link ExpressiveObjectsTransaction#flush() flush},
         * {@link ExpressiveObjectsTransaction#commit() commit} or
         * {@link ExpressiveObjectsTransaction#abort() abort}.
         */
         ...
         * 
         * <p>
         * May not {@link ExpressiveObjectsTransaction#flush()} or
         * {@link ExpressiveObjectsTransaction#commit() commit} (will throw an
         ...
         * <p>
         * May not {@link ExpressiveObjectsTransaction#flush()} or
         * {@link ExpressiveObjectsTransaction#abort() abort} or
         * {@link ExpressiveObjectsTransaction#commit() commit} (will throw
         ...
         * 
         * <p>
         * May not {@link ExpressiveObjectsTransaction#flush()},
         * {@link ExpressiveObjectsTransaction#commit() commit} or
         * {@link ExpressiveObjectsTransaction#abort() abort} (will throw
         * {@link IllegalStateException}).
         */
        ...
        /**
         * Whether it is valid to {@link ExpressiveObjectsTransaction#flush() flush} this
        ...
        /**
         * Whether it is valid to {@link ExpressiveObjectsTransaction#commit() commit} this
         * {@link ExpressiveObjectsTransaction transaction}.
         */
        ...
        /**
         * Whether it is valid to {@link ExpressiveObjectsTransaction#abort() abort} this
         * {@link ExpressiveObjectsTransaction transaction}.
         */
        ...
        /**
         * Whether the {@link ExpressiveObjectsTransaction transaction} is complete (and so a
    ...
    private static final Logger LOG = Logger.getLogger(ExpressiveObjectsTransaction.class);


    private final TransactionalResource objectStore;
    private final List<PersistenceCommand> commands = Lists.newArrayList();
    private final ExpressiveObjectsTransactionManager transactionManager;
    private final MessageBroker messageBroker;
    private final UpdateNotifier updateNotifier;
    private final List<ExpressiveObjectsException> exceptions = Lists.newArrayList();

    private State state;

    private RuntimeException cause;

    public ExpressiveObjectsTransaction(final ExpressiveObjectsTransactionManager transactionManager, final MessageBroker messageBroker, final UpdateNotifier updateNotifier, final TransactionalResource objectStore) {
    ...
    public void addException(ExpressiveObjectsException exception) {
        exceptions.add(exception);
    }
    
    public List<ExpressiveObjectsException> getExceptionsIfAny() {
    ...
    private void doFlush() {
        ...
        try {
            ...
            // this is because the Wicket viewer uses an implementation of ExpressiveObjectsContext 
    ...
    /**
     * The owning {@link ExpressiveObjectsTransactionManager transaction manager}.
     * 
     * <p>
