...
public abstract class AbstractServletOrFilterMapping {
    ...
    public AbstractServletOrFilterMapping(final Class<? extends Servlet> servletOrFilterClass, final String... pathSpecs) {
        this(servletOrFilterClass, Collections.EMPTY_MAP, pathSpecs);
    }

    public AbstractServletOrFilterMapping(final Class<? extends Servlet> servletOrFilterClass, final Map<String, String> initParams, final String... pathSpecs) {
