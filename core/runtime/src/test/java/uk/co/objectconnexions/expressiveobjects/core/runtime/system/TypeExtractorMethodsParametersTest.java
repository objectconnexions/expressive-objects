...
import uk.co.objectconnexions.expressiveobjects.core.metamodel.specloader.traverser.TypeExtractorMethodParameters;
...
public class TypeExtractorMethodsParametersTest {
    ...
    public void shouldFindGenericTypes() throws Exception {
        ...
        assertThat(extractor.getClasses(), ExpressiveObjectsMatchers.containsElementThat(equalTo(java.util.List.class)));
        assertThat(extractor.getClasses(), ExpressiveObjectsMatchers.containsElementThat(equalTo(Customer.class)));
    }
