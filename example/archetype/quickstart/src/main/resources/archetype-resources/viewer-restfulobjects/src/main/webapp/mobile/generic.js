var util = namespace('uk.co.objectconnexions.expressiveobjects.viewer.json.jqmobile.util');
var generic = namespace('uk.co.objectconnexions.expressiveobjects.viewer.json.jqmobile.generic');
