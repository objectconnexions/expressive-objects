...
package uk.co.objectconnexions.expressiveobjects.example.domainservice.email;
...
public class EmailService extends AbstractFactoryAndRepository {
    ...
    protected void send(String smtpHost, int smtpPort, String from, String to, String subject, String content) {
        try {
            ...
            email.addTo("rmatthews@expressive.objectconnexions.co.uk", "John Doe");
            email.setFrom("me@apache.org", "Me");
            email.setSubject(subject);
            email.setMsg(content);
            email.send();
        } catch (EmailException e) {
            throw new uk.co.objectconnexions.expressiveobjects.service.email.EmailException(e.getMessage(), e);
        }
    }
*/
    ...
    public void send(Email emailObject) {
        ...
        try {
            ...
            throw new uk.co.objectconnexions.expressiveobjects.example.domainservice.email.EmailException(e.getMessage(), e);
        }
    }
}
